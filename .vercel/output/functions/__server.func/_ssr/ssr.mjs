...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-C87UQ3pL.mjs");
...
var manifest = {
	"3c3d9b7498266ffe776c7abe4931e7d6814d83a2cc54814d1a906c8116873164": {
		functionName: "getBootstrap_createServerFn_handler",
		importer: () => import("./store-B0WHauI3.mjs")
	},
	"41f7404c27f56955d8d712680f170a6d0c0454d96a0844fc3cae729fbec24ed6": {
		functionName: "payMembership_createServerFn_handler",
		importer: () => import("./store-B0WHauI3.mjs")
	},
	"512e4f8b397549830348b5d5c540b3e4a87895a1dabbea707b6a6d1916cd87b5": {
		functionName: "adminGet_createServerFn_handler",
		importer: () => import("./store-B0WHauI3.mjs")
	},
	"8662d55d0f9c4a18986298cf1f639aef137675a54a70fd4bd9b34cc5901ab4de": {
		functionName: "adminSaveSettings_createServerFn_handler",
		importer: () => import("./store-B0WHauI3.mjs")
	},
	"b7105fa4bf58115823b7cbe9542d404fd0c0211149f9537d34bb677cb4b4df5a": {
		functionName: "acceptLegal_createServerFn_handler",
		importer: () => import("./store-B0WHauI3.mjs")
	},
	"d3b7b53c448e34e2ae20831ac9d26c8d0307e706bede78bcad2ef271523cad7a": {
		functionName: "adminUpdateOrder_createServerFn_handler",
		importer: () => import("./store-B0WHauI3.mjs")
	},
	"d52cdb5312482319bc218dc17cf2ccb1bf94eb34aab37a1df68e32d7857b07e5": {
		functionName: "placeOrder_createServerFn_handler",
		importer: () => import("./store-B0WHauI3.mjs")
	},
	"daf7da1f4472cd1027e735edb884770371e0e02190fa6e52d3133d2f6beba984": {
		functionName: "listMyOrders_createServerFn_handler",
		importer: () => import("./store-B0WHauI3.mjs")
	},
	"e9bd5391a0bc3b42821b87419c6982db35c6d192dda841d8ef95e6bc6b28eb27": {
		functionName: "adminSaveProduct_createServerFn_handler",
		importer: () => import("./store-B0WHauI3.mjs")
	},
	"f2b124e566eb207695960765c79e9ceece9f371548ce0fc2bd53129a7a67f84c": {
		functionName: "adminSalesCsv_createServerFn_handler",
		importer: () => import("./store-B0WHauI3.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DeKLC62H.mjs").then((n) => n.t),
